    ...
    <main className="shell">
      ...
      <section className="panel mediaBay" id="the-tube">
        ...
        <div className="mediaLayout">
          ...
          <div className="videoShelf">
            <form className="videoForm"><h4>Add something to her shelf</h4><input type="url" placeholder="YouTube link" /><div className="videoFormRow"><input placeholder="Title" /><input placeholder="Start · 0:23" /></div><textarea placeholder="When should Sophia use this?" /><button type="button">Save video</button></form>
      ...
      <section className="workspace">
        <article className="conversation panel">
          ...
          <div className="messages">
            ...
            <div className="message sophia"><span>S</span><div><small>Sophia · just now</small><p>Yeah, I think the headset and voice loop are finally behaving—what do you want to test next?</p></div></div>
            <div className="message tony"><span>T</span><div><small>Tony · 12s ago</small><p>That worked wonderfully.</p></div></div>
            <div className="message sophia"><span>S</span><div><small>Sophia · 11s ago</small><p>Good. I rather like being awake without tripping over my own voice.</p></div></div>
          </div>
      ...
      <section className="intelligenceGrid">
        <article className="panel memoryPanel">
          <div className="panelHeader"><div><p className="eyebrow">LONG-TERM MEMORY</p><h3>What Sophia remembers</h3></div><small>12 memories · 4 sessions</small></div>
          <form className="memoryForm"><select defaultValue="fact"><option value="fact">Fact</option><option value="preference">Preference</option><option value="goal">Goal</option></select><input placeholder="Subject · optional" /><input placeholder="Something Sophia should remember" /><label>Importance <input type="range" min="0" max="1" step="0.1" defaultValue="0.6" /></label><label className="pinMemory"><input type="checkbox" /> Pin</label><button type="button">Remember</button></form>
          ...
          <details className="sessionHistory"><summary>Recent session summaries</summary><div><div className="sessionItem"><time>Today · 4:34 PM</time><p>Tony spoke 13 times; Sophia responded 17 times and used 2 media actions.</p><small>13 Tony · 17 Sophia · 2 tools · $0.0919</small></div></div></details>
        </article>
